...
<div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
    ...
    <div class="d-flex align-items-center gap-2 flex-wrap">
        <form method="get" action="{{ url()->current() }}" id="internship-search-form" class="search-form">
            <div class="input-group">
                ...
                <button class="btn btn-primary" type="submit" id="internship-search-submit">Search</button>
            </div>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="internshipFilter" aria-labelledby="internshipFilterLabel">
    ...
    <div class="offcanvas-body">
        <form method="get" id="internship-filter-form" class="d-flex flex-column gap-3">
            ...
            <div class="d-flex gap-2">
                <button type="button" class="btn btn-outline-secondary flex-fill" id="internship-filter-reset" data-reset-url="{{ $resetUrl }}">Reset</button>
