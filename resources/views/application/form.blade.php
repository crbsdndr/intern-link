<form action="{{ $action }}" method="POST">
    ...
    <div class="mb-3">
        ...
        <select name="student_id" class="form-select searchable">
    ...
    <div class="mb-3">
        ...
        <select name="institution_id" class="form-select searchable">
    ...
    <div class="mb-3">
        ...
        <select name="status" class="form-select searchable">
